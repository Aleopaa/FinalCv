...
export default class Project
{
    ...
    setFloor()
    {
        ...
        // Material
        this.floor.material = new THREE.MeshBasicMaterial({map: this.floor.texture, transparent: true, depthWrite: false
        })
        // Mesh
        ...
        this.floor.area = this.areas.add({
            position: new THREE.Vector2(this.x + 0.5 + this.link.x, this.y - 3 + this.floor.y + this.link.y),
        ...
        this.floor.areaLabel.position.x = this.link.x + 0.5
        this.floor.areaLabel.position.y = this.link.y - 3
